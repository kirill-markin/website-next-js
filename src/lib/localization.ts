...
export function getUrlForLanguage(
    ...
    if (queryParams.category) {
        ...
        const knownCategories = ['all', 'people', 'business', 'journalists', 'police'];
    ...
    services: {
        'en': {
            ...
            categoryMetadata: {
                ...
                police: {
                    metaTitle: 'AI Services for Police | Law Enforcement Technology Consulting',
                    metaDescription: 'Strategic AI and technology consulting for law enforcement. Secure, professional guidance for mission-critical police operations.'
                }
            }
        },
        'es': {
            ...
            categoryMetadata: {
                ...
                police: {
                    metaTitle: 'Servicios de IA para Policía | Consultoría Tecnológica Policial',
                    metaDescription: 'Consultoría estratégica de IA y tecnología para fuerzas del orden. Orientación profesional y segura para operaciones policiales de misión crítica.'
                }
            }
        },
        'zh': {
            ...
            categoryMetadata: {
                ...
                police: {
                    metaTitle: '警察人工智能服务 | 执法技术咨询 | 安全指导',
                    metaDescription: '为执法部门提供战略性人工智能和技术咨询。为关键任务行动提供安全、专业的指导。'
                }
            }
        },
        'ar': {
            ...
            categoryMetadata: {
                ...
                police: {
                    metaTitle: 'خدمات الذكاء الاصطناعي للشرطة | استشارات التكنولوجيا الشرطية',
                    metaDescription: 'استشارات استراتيجية للذكاء الاصطناعي والتكنولوجيا لإنفاذ القانون. إرشادات آمنة ومهنية للعمليات الشرطية الحساسة.'
                }
            }
        },
        'hi': {
            ...
            categoryMetadata: {
                ...
                police: {
                    metaTitle: 'पुलिस के लिए एआई सेवाएं | रणनीतिक पुलिस प्रौद्योगिकी परामर्श',
