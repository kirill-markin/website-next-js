                    ...
                    <div className={styles.fullWidthColumn}>
                        ...
                        <article className={styles.articleContent}>
                            <section>
                                ...
                                <p>When Jake was building a multi-agent system for automated widget generation, he initially went with AutoGPT because it seemed like the obvious choice from all the hype. We discussed the tradeoffs between AutoGPT vs LangChain vs custom solutions, and talked through what actually matters for production systems. The key question wasn't "what's most popular?" but "what gives you the most control over context and behavior?" We also worked through specific issues like agent supervisors trying to do work themselves instead of properly delegating to specialized agents. Turns out, sometimes boring and custom beats exciting and uncontrollable.</p>
                            ...
                            <section>
                                ...
                                <p>Ryan came to me at the MVP stage of his data analysis product. He had designed the core data structure and workflow, but as someone new to the business side, he needed someone to say "yes, this will work" or "no, this is going to explode at scale." We worked through his structure, discussed what would scale vs. what would break at 10x volume, talked through commercialization strategies for data products (because building cool tech that nobody buys is just an expensive hobby), and made sure he was building on solid foundations rather than optimistic assumptions.</p>
                            ...
                            <section>
                                ...
                                <p>I've debugged agent systems where the supervisor kept trying to do work itself instead of delegating to specialized agents — turns out, conversation history management was the issue, not the framework choice. I've seen context control problems that looked like model quality issues but were actually framework overhead injecting mystery tokens. These kinds of patterns repeat across projects, and recognizing them early saves months of debugging.</p>
